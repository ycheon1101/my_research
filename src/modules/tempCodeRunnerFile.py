...
# instanciation model
model = SIREN_MLP(in_feature=2, hidden_feature=128, hidden_layers=8, out_feature=3)

# optimizer
optimizer = optim.Adam(model.parameters(), lr=learning_rate) 

# set target
table_images.dir_path = '/Users/yerin/Desktop/my_research/src/images/siren_test'
table_images.file_list = os.listdir(table_images.dir_path)
# print(f'file_list: {table_images.file_list}')
